 ...
 * @since 2017-12-09
 */
@Component(WebConstant.ACTIONSTEP_CLICK)
public class ClickActionStep extends WebActionStep {
    private static final Logger logger = LoggerFactory.getLogger(ClickActionStep.class);
    
    @Override
    public String getName() {
        return WebConstant.ACTIONSTEP_CLICK;
    }
    ...
    public int execute(WebContext webContext) {
        ...
        try {
            ...
            logger.info("点击, locator:{}", params);
            uiService.click(webDriver, params);
        } catch (Exception e) {

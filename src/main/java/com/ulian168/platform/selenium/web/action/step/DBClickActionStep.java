 ...
 * @since 2017-12-09
 */
@Component(WebConstant.ACTIONSTEP_DBCLICK)
public class DBClickActionStep extends WebActionStep {
    private static final Logger logger = LoggerFactory.getLogger(DBClickActionStep.class);
    
    @Override
    public String getName() {
        return WebConstant.ACTIONSTEP_DBCLICK;
    }
    ...
    public int execute(WebContext webContext) {
        ...
        try {
            ...
            logger.info("双击, locator:{}", params);
            uiService.dbClick(webDriver, params);
        } catch (Exception e) {
